...
public class SkillServiceTest {
    ...
    void testSaveValidSkill() {
        ...
        assertNotNull(savedSkill.getId(), "El objeto guardado debe de tener un ID asignado");
    ...
    void testSaveInvalidSkill() {
        ...
        assertThrows(ValidationException.class, () -> skillService.save(invalidSkill),
                "Debe lanzarse una ValidatioException cuando el nombre de la Skill está vacío");
    }
